...
const create = Joi.object({
  ...
  fechaNacimiento:  Joi.date().iso().max('now').allow(null)
    .messages({ 'date.max': 'La fecha de nacimiento no puede ser futura.' }),
  alergias:         Joi.string().trim().max(1000).allow('', null),
