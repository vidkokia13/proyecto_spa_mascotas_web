  ...
  routes: [
    ...
    // ─── Admin / Jefe ─────────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        {
          path: 'reportes',
          name: ROUTE_NAMES.ADMIN_REPORTES,
          component: () => import('@/presentation/views/admin/ReportesView.vue'),
          meta: { requiresAuth: true, layout: 'dashboard' },
          beforeEnter: roleGuard([ROLES.ADMIN, ROLES.JEFE]),
        },
        {
    ...
    // ─── Recepcion ────────────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        {
          path: 'reportes',
          name: ROUTE_NAMES.RECEPCION_REPORTES,
          component: () => import('@/presentation/views/recepcion/ReportesView.vue'),
          meta: { requiresAuth: true, layout: 'dashboard' },
          beforeEnter: roleGuard([ROLES.RECEPCION, ROLES.ADMIN, ROLES.JEFE]),
        },
      ],
    ...
    // ─── Employee (groomer) ───────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        {
          path: 'reportes',
          name: ROUTE_NAMES.EMPLOYEE_REPORTES,
          component: () => import('@/presentation/views/employee/ReportesView.vue'),
          meta: { requiresAuth: true, layout: 'dashboard' },
          beforeEnter: roleGuard([ROLES.TRABAJADOR]),
        },
      ],
    ...
    // ─── Client ───────────────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        {
          path: 'historial',
          name: ROUTE_NAMES.CLIENT_HISTORIAL,
          component: () => import('@/presentation/views/client/HistorialClinicoView.vue'),
          meta: { requiresAuth: true, layout: 'dashboard' },
          beforeEnter: roleGuard([ROLES.CLIENTE]),
        },
        {
          path: 'mis-promociones',
          name: ROUTE_NAMES.CLIENT_MIS_PROMOCIONES,
          component: () => import('@/presentation/views/client/MisPromocionesView.vue'),
          meta: { requiresAuth: true, layout: 'dashboard' },
          beforeEnter: roleGuard([ROLES.CLIENTE]),
        },
      ],
